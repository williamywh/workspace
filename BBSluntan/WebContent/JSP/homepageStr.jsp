...
<center>
  ...
  <table bgcolor="#007DC6" border="0" cellspacing="0" cellpadding="0" width="98%" height="21" style="border:1px #666666 solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px;width:98%;">
    <tbody>
      <tr>
        <td align="right" valign="center"><span title="注册新账号"><!--<a href="待输入">--><font color="#FFFFFF">用户：<%=DB.user%></font></a></span><font color="#FFFFFF"> | </font> <span title="会员登录论坛"><a href="Login.jsp"><font color="#FFFFFF">退出</font></a></span><font color="#FFFFFF"> | </font> <span title="帮助及常见问题"><a href="待输入" target="_blank"><font color="#FFFFFF">帮助</font></a></span><font color="#FFFFFF"> | </font>&nbsp;&nbsp; <br></td>
      </tr>
      <tr> </tr>
    </tbody>
  </table>
  ...
  <table border="0" cellspacing="1" cellpadding="4" width="98%" class="board">
    <tbody>
      ...
      <tr class="even">
        ...
        <td width="36%" valign="top" onMouseOver="this.style.backgroundColor=&#39;#e9e9e9&#39;; this.style.cursor=&#39;hand&#39;;" onMouseOut="this.style.backgroundColor=&#39;#f7f7f7&#39;;" onClick="window.location.href=&#39;post/page?bid=1&amp;sty=1&amp;age=0&#39;"><a href="PostDisplayStr.jsp?id=<%=a.getId()%>"><b><%=a.getTitle() %></b></a></td>
        <td nowrap="" align="center" width="14%"><%=a.getUser() %></td>
