...
rng.collapse(false);
  ...
  <table width="95%" cellspacing="0" cellpadding="2" border="0">
    <tbody>
      <tr>
        <td><b><font size="3" face="arial"><b>&#187;</b></font>&nbsp;<a href="http://www.cjsdn.net/index.html" class="nav"><b>首页</b></a>&nbsp;<font size="3" face="arial"><b>&#187;</b></font></b></td>
      </tr>
    </tbody>
  </table>
  <table width="95%" cellspacing="0" cellpadding="2" border="0">
                    ...
                    <tbody>
                      <tr>
                        <td bgcolor="#9a9a9a"><table border="0" cellspacing="1" cellpadding="0">
                            <tbody>
                              <tr>
                                <td><a href="http://localhost:8080/BBSS/post.jsp"><img src="../images/post-16x16.gif" alt="发表新主题" border="0" height="16" width="16"></a></td>
                                <td><a href="http://localhost:8080/BBSS/post.jsp">发表新主题</a></td>
                              </tr>
                              <!--<tr align="center">--> 
  ...
  <table border="0" cellspacing="1" cellpadding="4" width="95%">
    <tbody>
      <tr class="head">
        ...
        <td><font color="#ffffff"><b> 主题：<%=a.getCont() %></b></font></td>
      ...
      <tr class="odd">
        <td width="150" height="199" valign="top"><b>JiafanZhou</b> <br>
